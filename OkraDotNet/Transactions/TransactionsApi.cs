...
namespace OkraDotNet.Transactions
{
    public interface ITransactionsApi
    {
        ...
        /// <summary>
        /// Receive customer-authorized transaction data for current, savings, and domiciliary Accounts as pdf file link
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Allows you to fetch transactions info using the options metadata you provided when setting up the widget
        /// </summary>
        /// <param name="request"></param>
        /// <returns></returns>
